<script>
document.title = "Cookie Policy - GoForTaxis";
document.getElementsByTagName('meta')["keywords"].content = "";
document.getElementsByTagName('meta')["description"].content = "GoForTaxis ";
</script>
   ...
   <div class="inner-pages">
      <div class="banner-top-sec cta lgl">
         <div class="container">
            <div class="col-sm-10">
               <div class="text-cart">
                  <h2 class="heading ttu fwb">Cookie Policy</h2>
                  <ol class="breadcrumb">
                     <li><a href="/">Home</a></li>
...
<p>In this Cookie Policy, we will provide you with detailed information on how GoForTaxis (hereinafter &ndash; the "we" or "our"), shall undertake to ensure the security of personal information and the protection of rights of the visitors and users of the websites (hereinafter &ndash; the "Visitors", "You") while you use our websites including but not limited to https://GoForTaxis .com (hereinafter &ndash; the "Site") and the content on it.</p>
