...
<div class="footer-section3 bgc py-3">  
<div class="pt-4 pb-2">
...
<h4>Top Airlines</h4>
<ul>
<li><a href="<?= base_url() ?>united-airlines">United Airlines</a></li>
...
<li><a href="<?= base_url() ?>klm-airlines">KLM Airlines</a></li>
</ul>
</div>
...
<br><h6>Disclaimer:</h6>
<p>Fareocean, on the other hand, cherishes its consumers because we are just a travel agency that provides a service. Our staff works hard to provide users with a low-cost flight booking experience. We do not have any influence over the airline. Be cautious while making your reservation because any changes to your itinerary will result in costs based on the airline's policies. We will provide our best to safeguard our user interest. <a href="<?= base_url() ?>disclaimer" class="link-primary">Read More.</a>
</p>
...
<div class="container">
 <p>FAREOCEAN its registered office located at Address: 134 South St., in the city of Windham Zip Code 12496 in the state of New York (USA). A Unit of Skyhyplanners LLC, We are available to provide customer support on all days from Monday to Sunday. Customer Service Number: <?= TFN ?> | Email: <?= EMAIL ?> © Copyrights 2023. <?= WEBSITE ?>.</p>      
...
$("#banner01").owlCarousel({
	  items:1, autoplay:true,autoplayHoverPause:true,
	  dots:false,
	  loop:true,
