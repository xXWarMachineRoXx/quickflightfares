...
document.getElementsByTagName('meta')["description"].content = " Get the best fairs With US - call us @ <?= TFN ?>";   
   ...
   <div id="header-wrapper" class="wrap-inpg py-4 py-md-5"  style="background-image: url('frontend/images/spirit-air.jpg'); background-position: bottom;background-no-repeat: no-repeat; background-size: cover;">
